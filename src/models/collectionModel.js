...
function secondType(barcode) {
    let data = {};
    let count = 0;
    if (calculateModule10(barcode.substr(0, 11)) !== parseInt(barcode.substr(11, 1))) count += 1;
    if (calculateModule10(barcode.substr(12, 11)) !== parseInt(barcode.substr(23, 1))) count += 1;
    if (calculateModule10(barcode.substr(24, 11)) !== parseInt(barcode.substr(35, 1))) count += 1;
    if (calculateModule10(barcode.substr(36, 11)) !== parseInt(barcode.substr(47, 1))) count += 1;
    ...
    if (compare !== parseInt(barcode.substr(3, 1))) count += 1;
